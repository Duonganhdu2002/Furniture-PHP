<div class="category">
    <table class="category-data-table">
        ...
        // SQL query to retrieve category data with pagination
        $sql = "SELECT id, category_name, description FROM categories LIMIT $offset, $itemsPerPage";
        $result = $conn->query($sql);

        // Include appropriate file based on 'categoryId' parameter
