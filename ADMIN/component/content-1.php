...
<div class="why-choose-section">
    <div class="container">
        <div class="left-side-ct3">
            ...
            <div class="for-stack">
                <div class="two-stack">
                    <div class="feature">
                        <div class="icon">
                            <img src="../PUBLIC-PAGE/images/truck.svg" alt="Image" class="imf-fluid">
                        </div>
                    ...
                    <div class="feature">
                        <div class="icon">
                            <img src="../PUBLIC-PAGE/images/bag.svg" alt="Image" class="imf-fluid">
                        </div>
                        <h3>Easy to Shop</h3>
                ...
                <div class="two-stack">
                    <div class="feature">
                        <div class="icon">
                            <img src="../PUBLIC-PAGE/images/support.svg" alt="Image" class="imf-fluid">
                        </div>
                        <h3>24/7 Support</h3>
                    ...
                    <div class="feature">
                        <div class="icon">
                            <img src="../PUBLIC-PAGE/images/return.svg" alt="Image" class="imf-fluid">
                        </div>
        ...
        <div class="right-side-ct3">
            <div class="img-wrap">
                <img src="../PUBLIC-PAGE/images/why-choose-us-img.jpg" alt="Image" class="img-fluid">
            </div>
        </div>
