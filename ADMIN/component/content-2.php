...
<div class="we-help-section">
    <div class="container-ct4">
        <div class="left-side-ct4 imgs-grid">
            <div class="behind ">
                <div class="grid grid-1"><img src="../PUBLIC-PAGE/images/img-grid-1.jpg" alt="Image"></div>
                <div class="grid grid-2"><img src="../PUBLIC-PAGE/images/img-grid-2.jpg" alt="Image"></div>
            </div>
            <div class="front">
                <div class="grid grid-3"><img src="../PUBLIC-PAGE/images/img-grid-3.jpg" alt="Image"></div>
            </div>
        </div>
